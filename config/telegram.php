...
use App\Telegram\Commands\ApartmentCommand;
use App\Telegram\Commands\DangerCommand;
use App\Telegram\Commands\DangerNoticesCommand;
use App\Telegram\Commands\IntercomCommand;
use App\Telegram\Commands\IntercomNoticesCommand;
use App\Telegram\Commands\StartCommand;
use App\Telegram\Commands\SupportCommand;
use App\Telegram\Commands\UnkownCommand;
...
return [
    ...
    */
    'bots' => [
        'mybot' => [
            'token' => env('TELEGRAM_BOT_TOKEN', '7731831213:AAHJ5MRRkKZrfUjEcZmT_YooGI_iwNaC1lU'),
    ...
    */
    'commands' => [
        ...
        ApartmentCommand::class,
        DangerCommand::class,
        IntercomCommand::class,
        DangerNoticesCommand::class,
        IntercomNoticesCommand::class,
    ...
    */
    'shared_commands' => [
        ...
        'unknown' => UnkownCommand::class,
        'apartment' => ApartmentCommand::class,
    ],
];
